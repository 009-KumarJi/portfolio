  ...
  return (
    <div className="p-4">
      ...
      <div className="text-sm mb-4">
        <p className="mb-2">+919755296678 • krishna902kumar@gmail.com</p>
        <p className="mb-2">
          <a href="https://linkedin.com/in/krishna-kumar-975b25186" className="text-blue-600 hover:underline">linkedin.com/in/krishna-kumar-975b25186</a> • 
          <a href="https://github.com/009-KumarJi" className="text-blue-600 hover:underline ml-1">github.com/009-KumarJi</a>
        </p>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="flex justify-between">
          <div>
            ...
            <p className="text-sm">Bachelor of Engineering, CGPA - 7.22 (7th Sem)</p>
          </div>
      ...
      <div className="mb-4">
        ...
        <div className="mb-2">
          <div className="flex justify-between">
            <p className="font-semibold text-sm">Packaged App Developer Associate Intern (current)</p>
      ...
      <div className="mb-4">
        ...
        <ul className="list-disc pl-5 text-sm">
          <li className="mb-1">
            <span className="font-semibold">NoviConnect-ChatApp</span> – A real-time chat application enabling seamless communication through features like group chat, user presence badges, and JWT authentication. Tech Stack: ReactJS, Node.js, Express.js, MongoDB, Socket.IO. 
            <a href="https://github.com/009-KumarJi" className="text-blue-600 hover:underline ml-1">GitHub</a> —
            <a href="#" className="text-blue-600 hover:underline ml-1">Demo</a>
          </li>
          <li className="mb-1">
            <span className="font-semibold">Inventory Management System</span> – Python-based system for inventory tracking with product management and user-friendly UI. Tech Stack: Flask, MySQL, HTML, CSS.
            <a href="https://github.com/009-KumarJi" className="text-blue-600 hover:underline ml-1">GitHub</a>
          </li>
          <li>
            <span className="font-semibold">Article CMS</span> – Backend for managing articles with RBAC for roles like User, Moderator, and Admin. Tech Stack: Node.js, Express.js, MongoDB, Cloudinary.
            <a href="https://github.com/009-KumarJi" className="text-blue-600 hover:underline ml-1">GitHub</a>
          </li>
        </ul>
      </div>
